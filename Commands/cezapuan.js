...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.send(embed.setDescription(`${victim} adlı üyenin toplam ${cpuan || '0'} adet ceza puanı mevcut (\`${durum}\`)`).setFooter(`Daha Detaylı Bilgi İçin 10 Saniye İçerisinde Emojiye Tıklayabilirsin.. ALSANCAK`)).then(x => {
        x.react("✅");
